...
class ForecastDataModel {
  ...
  ForecastDataModel({this.dt, this.main, this.weather, this.clouds, this.wind, this.visibility, this.pop, this.sys, this.dtTxt});
  ...
  static List<ForecastDataModel> fromList(List<Map<String, dynamic>> list) {
    return list.map(ForecastDataModel.fromJson).toList();
  }
